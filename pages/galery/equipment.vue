  ...
  <section class="equipment">
    <div class="container">
      <div class="equipment__title">
        ...
        <p class="subtitle">
          - импульсный источник <span>моноблок Bowens XMS 1000</span> нового поколения
        </p>
        <p class="subtitle">
          - постоянный источник света <span>LED видеосвет</span> BOLING 120W CRI 95+ bicolor<br>
