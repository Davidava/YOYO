<template>
  <section class="alana">
    <div class="container">
      ...
      <div class="alana__content">
        <div class="row justify-content-center">
          <div class="col-md-8">
            <ImageItem
              v-for="item, index in gridImages.firstColumn"
              :key="index"
              :url="item.src"
              :width="item.width"
              :height="item.height"
          ...
          <div class="col-md-6">
            <ImageItem
              v-for="item, index in gridImages.secondColumn"
              :key="index"
              :url="item.src"
              :width="item.width"
              :height="item.height"
          ...
          <div class="col-md-7">
            <ImageItem
              v-for="item, index in gridImages.thirdColumn"
              :key="index"
              :url="item.src"
              :width="item.width"
              :height="item.height"
